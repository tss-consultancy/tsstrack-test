                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">
                                <a href="{{ url('/allowed-ips/create') }}">Edit IP</a>
                            </li>
                        </ol>
                    </nav>
                </div>
        ...
        <form action="#" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="input-style-1 drop-1">
                            ...
                            <select class="form-select" name="status" id="ipstatus">
                                ...
                                <option value="1" {{ $ip->status == 1 ? 'selected' : '' }}>Active</option>
                                <option value="0" {{ $ip->status == 0 ? 'selected' : '' }}>Inactive</option>
                            </select>
                            <span class="text-danger">
                                @error('status')
                                {{ $message }}
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            <label>CITY</label>
                            <input type="text" name="city" id="cities" value="{{ old('city', $ip->city) }}" readonly />
                            <span class="text-danger">
                                @error('city')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            <label>STATE</label>
                            <input type="text" name="state" id="states" value="{{ old('state', $ip->state) }}" readonly />
                            <span class="text-danger">
                                @error('state')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            <label>COUNTRY</label>
                            <input type="text" name="country" id="countries" value="{{ old('country', $ip->country) }}" readonly />
                            <span class="text-danger">
                                @error('country')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            <label>AREA</label>
                            <input type="text" name="area" id="areas" value="{{ old('area', $ip->area) }}" readonly />
                            <span class="text-danger">
                                @error('area')
                                {{ $message }}
                                @enderror
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <input type="text" name="description" value="{{ old('description', $ip->description) }}" />
                            <span class="text-danger">
                                @error('description')
                                {{ $message }}
                                @enderror
