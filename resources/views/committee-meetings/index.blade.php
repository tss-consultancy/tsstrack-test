                        ...
                        <table id="myTable" class="table table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="wrap-text">
                                        {{ $meeting->committee->committee_name ?? 'N/A' }}
                                    </td>

                                    <td>{{ \Carbon\Carbon::parse($meeting->date_of_notice)->format('d-m-Y')}}</td>
                                    <td>{{ \Carbon\Carbon::parse($meeting->date_of_meeting)->format('d-m-Y')}}</td>
                                   
                                    <td>
                                        @if(empty($meeting->minute))
                                            Not set
                                        @else
                                        <a href="{{ url('uploads/' . basename($meeting->minute)) }}" target="_blank" class="btn btn-primary" >View</a>
                                        @endif
                                    </td>
