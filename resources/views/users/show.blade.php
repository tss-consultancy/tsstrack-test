                ...
                <td>
                    <div class="action">
                        <button  class="edit border-0"> 
                            <a title="Edit" href="{{url('users/edit', ['id' => $user->id])}}">
                                <i class="lni lni-pencil px-2 mx-1 py-2 text-light bg-success rounded"></i>
                            </a>
                        </button>
                        <button class="edit border-0"> 
                            <a title="Delete" href="{{url('users/delete', ['id' => $user->id])}}" onclick="return confirm('Are you sure you want to delete this user?');">
