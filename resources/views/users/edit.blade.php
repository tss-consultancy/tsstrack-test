                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        ...
                        <input type="text" name="name" placeholder="Enter  your  full  Name" value="{{$user->user_name}}"/>
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        <label>Email</label>
                        <input type="email" name="email" placeholder="Email" value="{{$user->user_email}}" />
                        <span class="text-danger">
                          @error('email')
                          {{$message}}
                          @enderror
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        ...
                        <input type="password" name="password" placeholder="Password" value="{{$user->user_password}}"/>
                        <span class="text-danger">
                              @error('password')
                              {{$message}}
                              @enderror
                    ...
                    <div class="col-12">
                      <div class="input-style-1">
                        ...
                        <input type="number" name="phone_no" placeholder="Phone No." value="{{$user->user_mobile}}" />
                        <span class="text-danger">
                          @error('phone_no')
                          {{$message}}
                          @enderror
