                        ...
                        <table id="myTable" class="table table-striped table-bordered " style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $member->committee ? $member->committee->committe_name : 'N/A' }}
                                    </td>
                                        ...
                                        <div class="action ">
                                            ...
                                            <button class="border-0">
                                                <a title="Show" class="text-success"
                                                    href="{{url('members/show',['id'=>$member->member_id])}}"><i
                                                        class="lni lni-eye px-2 mx-1 py-2 text-light bg-primary rounded"></i></a></button>
                                            </button>
                                            <button class="border-0">
                                                <a title="Edit"
                                                    href="{{url('members/edit',['id'=>$member->member_id])}}"><i
                                            ...
                                            <button class="border-0">
                                                <a title="Delete"
                                                    href="{{url('members/delete',['id'=>$member->member_id])}}"
