...
<div class="container-fluid">
    ...
    <div>
        <div class="card-style settings-card-2 mb-30">
            <form id="committeeMeetingForm" action="{{url('committee-meetings/create')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="input-style-1 drop-1">
                            ...
                            <select class="form-select" name="cname" id="committees">
                                ...
                                <option value="{{ $committee->committe_id }}"
                                    {{ (isset($committee_meetings) && $committee_meetings->committe_id == $committee->committe_id) ? 'selected' : '' }}>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(key, member) {
                $('#members').append('<option selected value="' + member.member_id + '">' + member
                    .member_name + '</option>');
            });
        },
