                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="input-style-1">
                            ...
                            <select class="" name="committees" id="committees">



                                @foreach ($committee_names as $meeting)
                                <option value="{{ $meeting->committe_id }}"
                                    {{ $meeting->committe_id == old('committe_id', $committee_meetings->committe_id) ? 'selected' : '' }}>
                                    {{$meeting->committe_name}}
                                </option>
                                @endforeach
