                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{ $committee_meetings->committee->committe_name }}
                            ...
                            <tr>
                                ...
                                <td>{{$committee_meetings->date_of_notice}}</td>
                            </tr>
                            <tr>
                                <th>
                                    <h6>Date Of Meeting</h6>
                                </th>
                                <td>{{$committee_meetings->date_of_meeting}}</td>
                            </tr>
                            <tr>
                                <th>
                                    <h6>Meeting From</h6>
                                </th>
                                <td>{{\Carbon\Carbon::parse($committee_meetings->committee_meeting_start_time)->format('h:i A')}}</td>
                            </tr>
                            <tr>
                                <th>
                                    <h6>Meeting To</h6>
                                </th>
                                <td>{{\Carbon\Carbon::parse($committee_meetings->committee_meeting_end_time)->format('h:i A')}}</td>
                            </tr>
                            <tr>
                                <th>
                                    <h6>Meeting Room</h6>
                                </th>
                                <td>{{$committee_meetings->meetingroom->meeting_room_name}}</td>
                            </tr>
                            <tr>
                                <th>
                                    <h6>Meeting Link</h6>
                            ...
                            <th>
                                ...
                                <td>
                                        @if(empty($committee_meetings->minut))
                                            Not set
                                        @else
                                        <a href="{{ url('uploads/' . basename($committee_meetings->minut)) }}" target="_blank" class="btn btn-primary" >View</a>
                                        @endif
                                    </td>
                            </th>
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $value->member->member_name }}</td>
                                <td>{{ $value->member->member_email }}</td>
                                <td>
                                    @if($value->status == 1)
