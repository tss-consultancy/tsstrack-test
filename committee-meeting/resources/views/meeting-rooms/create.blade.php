    ...
    <div class="title-wrapper pt-30">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active">
                        <a href="{{url('/meeting-rooms/create')}}">Add Meeting Room</a>
                      </li>
                    </ol>
                  </nav>
                </div>
            ...
            <div>
              <div class="card-style settings-card-2 mb-30">
                <form action="{{url('/meeting-rooms/create')}}", method="POST">
                  @csrf
                  <div class="row">
                    ...
                    <div class="col-xxl-4">
                      <div class="input-style-1">
                        ...
                        <input type="text" name="title" placeholder="Enter Meeting Room Name" /><span class="text-danger">
                          @error('title')
                          {{$message}}
                          @enderror
                        </span>
